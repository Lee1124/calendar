    ...
    <el-container>
      ...
      <el-aside>
        <div class="workBox" ref="workBox">
          <div class="title" :style="{paddingTop:workBoxTitlePaddingTop}">
            <span>工作提醒</span>
            <i>-</i>
      ...
      <el-main>
        <div class="change-calendar-btn" ref="changeCalendarBtn" :style="{top:changeCalendarBtnTop}">
...
<script>
  ...
  let myMethods = {
    ...
    getChangeCalendarBtnTop() {
      let bigHeight = $(this.$refs.calendar).outerHeight();
